...
export function PersonalTicketCard({ seq, position }: PersonalTicketCardProps) {
  return (
    <div
      aria-live="polite"
      className="flex justify-center items-center mx-auto w-full max-w-60 sm:max-w-sm h-full max-h-50 sm:max-h-sm rounded-2xl border border-white/10 bg-white/5 p-6 sm:p-8 text-center backdrop-blur"
    >
      <div>
